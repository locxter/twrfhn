...
function visualizeMove(gameState = 0) {
  ...
  CANVAS_OUTPUT_CONTEXT.textBaseline = 'top';
  CANVAS_OUTPUT_CONTEXT.fillText(gameState + '/' + (moves.length - 1), 150 * scalingRatio, 0);
  for (var i = 0; i < 3; i++) {
    // Drawing a rod
  ...
  // Drawing rod labels
  CANVAS_OUTPUT_CONTEXT.fillText('A', 50 * scalingRatio, 110 * scalingRatio);
  CANVAS_OUTPUT_CONTEXT.fillText('B', 150 * scalingRatio, 110 * scalingRatio);
  CANVAS_OUTPUT_CONTEXT.fillText('C', 250 * scalingRatio, 110 * scalingRatio);
}
